...
module.exports = function(moo) {    
    var module = {
        ...
        , fichaUsuario: function(objUsuario) {
            ...
            var dtAlteracao = "";
            if (objUsuario.dtAlteracao) {
                dtAlteracao = "<span><label class='grid_label'>Última Alteração:  </label>" + objUsuario.dtAlteracao + "</span>";
            }
            
            var divContents = module.base.div("", ["class='grid_contents'"], email + dtCadastro + dtAlteracao + situacao + perfil);
