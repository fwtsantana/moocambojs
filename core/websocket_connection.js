...
exports.listen = function (port, host, connectionHandler) {
    ...
    var srv = http.createServer(function (req, res) {
        ...
        rs.on('error', function(){
            fs.createReadStream("./core/resources/pages/errors/notfound.html").pipe(res);
        });
    ...
    srv.on('upgrade', function (req, socket, upgradeHead) {
        ...
        ws.application = {
            name: undefined
            , sessionID: randomValueHex(12)
            , modules: {}
            , config: {
                global: require("../core/config.json")
                , local: undefined
            }
            , currentPage: {
                path: undefined
        ...
        ws.api = require("../core/websocket_api") (ws);
